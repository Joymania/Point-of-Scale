        ...
        <div class="row">
          ...
          <section class="col-md-12 ">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="{{ route('profiles.store',$editData->id) }}" id="myform" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                                    ...
                                    <input type="file" name="image" id="image" accept="image/*" class="form-control" onchange="preview_image(event)">
                                </div>
                                <div class="form-group col-md-2">
                                    <img id="showImage" src="{{(!empty($editData->image))? url('upload/user_images/'.$editData->image):url('upload/no_image.jpg') }}"
                                     style="width: 150px; height:160px; border:1px solid black";>
                                </div>
